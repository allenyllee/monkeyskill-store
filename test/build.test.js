...
test("Store publishes an immutable hashed Runner Bootstrap package", async () => {
  ...
  assert.equal(bootstrap.bootstrapUrl, "skills/monkeyskill-runner-bootstrap/1.0.1/bootstrap.json");
  ...
  const bootstrapInstructions = await readFile(new URL("../dist/skills/monkeyskill-runner-bootstrap/1.0.1/SKILL.md", import.meta.url), "utf8");
